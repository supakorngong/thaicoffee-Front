export function ProfileIcon() {
  return (
    <>
      <svg width="2.5rem" height="2.5rem" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
          {" "}
          <title>profile_round [#1342]</title> <desc>Created with Sketch.</desc> <defs> </defs>{" "}
          <g id="Page-1" stroke="#1a120e" stroke-width="1" fill="none" fill-rule="evenodd">
            {" "}
...
export function HistoryIcon() {
  return (
    <svg width="2.5rem" height="2.5rem" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000">
      <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
      <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
      <g id="SVGRepo_iconCarrier">
        {" "}
        ...
        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          {" "}
          <g id="icon" fill="#1a120e" transform="translate(33.830111, 42.666667)">
            {" "}
            <path
